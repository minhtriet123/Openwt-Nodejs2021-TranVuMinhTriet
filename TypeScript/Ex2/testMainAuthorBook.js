...
var classAuthor_1 = require("./classAuthor");
var classBook_1 = require("./classBook");
// Test Author class
var a1 = new classAuthor_1.Author("Tan Ah Teck", "ahteck@nowhere.com");
console.log(a1);
...
// Test Book class
var b1 = new classBook_1.Book("12345", "Java for dummies", a1, 8.8, 88);
console.log(b1);
b1.price = (9.9);
b1.qty = (99);
console.log(b1);
